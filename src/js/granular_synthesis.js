...
window.onload = function() {
  var fastSynth = new GranularSynth(context, '/data/short.wav', {grainsPerSecond: 10, grainLength: 4000, walkProbability: 0.5});
  var slowSynth = new GranularSynth(context, '/data/short.wav', {grainsPerSecond: 40, grainLength: 40000, walkProbability: 1});
